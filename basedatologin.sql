...
begin
insert into usuario (id, username, nombres, apellidos, dni, clave, telefono, correo) values
(r_id, r_username, r_nombres, r_apellidos, r_dni, r_clave, r_telefono, r_correo);
end $$
